...
switch ($_REQUEST["acao"]) {
    case "cadastrar":
        ...
        $sql = "INSERT INTO usuarios2 (email, nome_sobrenome, telefone, cpf, data_nascimento, senha, cep, rua, bairro, cidade, data_cadastro, uf, numero, ip_local, tipo_usuario) VALUES 
        ('{$email}', '{$nome_sobrenome}', '{$telefone}', '{$cpf}', '($data_nascimento)', '{$senha}', '{$cep}', '{$rua}', '{$bairro}', '{$cidade}', NOW(), '{$uf}', '{$numero}', '{$ip}', 'Cadastro')";
        ...
        case "novoCadastro":
           ...
           // Executar a consulta
            ...
            if (mysqli_num_rows($result) >= 1) {
                ...
                $sql = "INSERT INTO usuarios (email, nome_sobrenome, telefone, cpf, data_nascimento, nome_login, senha, cep, rua, bairro, cidade, data_cadastro, uf, numero, ip_local, tipo_usuario) VALUES 
                    ('{$email}', '{$nome_sobrenome}', '{$telefone}', '{$cpf}', '{$data_nascimento}', '{$senha}', '{$cep}', '{$rua}', '{$bairro}', '{$cidade}', NOW(), '{$uf}', '{$numero}', '{$ip}', 'Recadastrado')";
