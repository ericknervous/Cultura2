...
class WebserviceClient implements \Iterator, \ArrayAccess
{
   ...
   // tem que colocar na frente o tipo, se não não funciona, :void
   public function next()
   {
       return next($this->decoded_resposta);
   }

   // tem que colocar na frente o tipo, se não não funciona, :bool
   ...
   //ArrayAcess methods
   // tem que colocar na frente o tipo, tipo void, porém da o erro pois void não pode retornar algo, mixed não vai
   ...
   // ,,
   public function offsetExists($chave) :bool
   {
       $this->getRespostaConteudo(true);
   ...
   public function offsetSet($chave, $valor) :void
   {
       throw new WebserviceClientException("Decoded resposta data is immutable.");
   }

   public function offsetUnset($chave) :void
   {
       throw new WebserviceClientException("Decoded resposta data is immutable.");
   }
